lsUsing Vehicle as a base class, create three derived classes (Car, Motorcycle etc.), each derived class should have its own attributes in addition to the normal Vehicle attributes. 
